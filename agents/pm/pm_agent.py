...
class PMAgent(BaseAgent):
    ...
    def generate_roadmap(self, brief: str, client: str,
        ...
        user_prompt = (
            ...
            "- SIEMPRE incluir exactamente 4 fases: demo, development, "
            "testing, delivery en ese orden exacto — nunca combinar "
            "fases ni crear fases personalizadas\n"
            "- Los nombres de las fases deben ser exactamente: "
            "\"demo\", \"development\", \"testing\", \"delivery\" "
            "— sin sufijos ni prefijos\n"
