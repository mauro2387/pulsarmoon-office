...
class DevAgent(BaseAgent):
    ...
    def process_form(self, token: str, form_data: dict) -> str:
        ...
        prompt = (
            ...
            "El prompt debe:\n"
            "1. El proyecto ya tiene scaffold de Next.js 14 con "
            "TypeScript, Tailwind y App Router.\n"
            "   NO corras npx create-next-app — la estructura base "
            "ya existe.\n"
            "   Directamente creá o modificá los archivos necesarios.\n"
